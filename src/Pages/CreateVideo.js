  ...
  return (
    <div className="container d-flex flex-column align-items-center">
      ...
      <div className="lead mb-5 px-2 text-center">
        Fill this form and provide your content to create a video using SL in a
        few clicks!
      </div>
      ...
      <Row className="container">
        ...
        >
          ...
          <Form.Group controlId="type" as={Col} xs="12" md="7" className="my-3">
            ...
            >
              <option value="PUBLIC">
                Public - Your video will be visible to the entire communtiy
              </option>
              <option value="PRIVATE">
                Private - Your video can be accessed by people with whom you
                share the video ID
              </option>
            </Form.Select>
            <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
      ...
      <ConfirmModal
        ...
        onHide={(e) => {
          setShowModal(false);
          navigate("/equilearn/all-videos", { replace: true });
        }}
        videoId={videoId}
      />
    </div>
