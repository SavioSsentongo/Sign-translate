    ...
    <div className="container-fluid d-flex flex-column align-items-center px-0">
        ...
        <div className="card card mb-3 col-md-5 p-0 border border-primary">
          ...
          <div className="card-body d-flex flex-column justify-content-between">
            <div>
              ...
              <p className="card-text">
                Expert users who are well versed in Sign Language can help us by
                telling if the animated signs displayed on theis webapp are
                correct or not.
              </p>
            </div>
            <div className="mt-3">
        ...
        <div className="card card mb-3 col-md-5 p-0 border border-primary">
          ...
          <div className="card-body d-flex flex-column justify-content-between">
            <div>
              ...
              <p className="card-text">
                Novice users who may not know Sign Language can help us by
                rating the similarity of our animated signs with real life
                recorded signs.
              </p>
            </div>
            <div className="mt-3">
      ...
      <div className="container row d-flex justify-content-between">
        <div className="card card col-md-5 p-0 border border-primary">
          <div className="card-header text-center bg-primary text-white">
            Equilearn: Feedback Form 5
          </div>
          <div className="card-body d-flex flex-column justify-content-between">
            <div>
              <h5 className="card-title">Feedback on 'Create Video' module</h5>
              <p className="card-text">
                Help us know if our SL Video creation module is simple and easy
